      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Hero Apps is a modern application platform where users can explore,
            install, and manage high-quality mobile and web applications. 
            We focus on delivering performance, usability, and innovative digital experiences.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mb-4">
            Follow us on social media to get the latest updates, new apps, and features.
          </p>
