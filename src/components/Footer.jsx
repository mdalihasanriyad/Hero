  ...
  return (
    <footer className="bg-slate-900 text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            <div className="bg-blue-600 p-2 rounded-lg">
              <span className="font-bold italic">H</span>
            </div>
            <span className="font-bold text-xl uppercase">Hero Apps</span>
          </div>
          <p className="text-gray-400 text-sm leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt esse autem at, 
            laudantium dolores eaque expedita quidem eveniet, mollitia officiis.
          </p>
        </div>

        {/* Links Column 1 */}
        <div>
          <h4 className="font-bold mb-6">About Hero Apps</h4>
          <ul className="text-gray-400 space-y-3 text-sm">
            ...
            <li><a href="#" className="hover:text-white transition">Lorem ipsum dolor sit.</a></li>
          </ul>
        </div>
        ...
        {/* Social Icons */}
        <div>
          <h4 className="font-bold mb-6">Social Icons</h4>
